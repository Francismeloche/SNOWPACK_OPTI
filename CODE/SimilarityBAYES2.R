...
#ROOT <- args[1]
pro_folder   <- args[1]
path_topro_folder <- args[1]
print(path_topro_folder)
year  <- args[2]
...
profile_vector <- c('20191101.caaml','20191213.caaml','20200115.caaml','20200210.caaml','20200310.caaml','20200410.caaml')
